...
def main():
    ...
    st.image(EFU_IMAGE, caption="Huda Sha‘rawi from the Egyptian Feminist Union, who fought for the abolition of the institution of bayt al-ta’ ah (the house of obedience), meeting with women from various Arab countries.", width=400)
